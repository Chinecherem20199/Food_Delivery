package nigeriandailies.com.ng.fooddelivery;
...
import nigeriandailies.com.ng.fooddelivery.adapters.ResturantListAdapter;
import nigeriandailies.com.ng.fooddelivery.model.RestaurantModel;

public class MainActivity extends AppCompatActivity implements ResturantListAdapter.RestuarantListClickListerner {
    ...
    private void initRecyclerView(List<RestaurantModel> restaurantModelList ) {
        ...
        ResturantListAdapter adapter = new ResturantListAdapter(restaurantModelList, this);
